package ir.navaco.mcb.primacy.utils;
...
public final class DateUtils {
    ...
    public static String convertToJalaliString(LocalDateTime dateTime) {
        return convertToJalaliDateTimeString(DateUtils.convertToJalaliDate(dateTime));
    }

    public static String convertToJalaliString(LocalDate date) {
        return convertToJalaliDateString(DateUtils.convertToJalaliDate(date));
    }

    public static String convertToJalaliString(LocalTime time) {
        return convertToJalaliTimeString(DateUtils.convertToJalaliDate(time));
    }

    public static String convertToJalaliDateWithNameOfMonthString(LocalDate date) {
        return convertToJalaliDateWithNameOfMonthString(DateUtils.convertToJalaliDate(date));
    }
    ...
    public static Boolean isBeforeOrEqual(LocalDate first, LocalDate second) {
        return isEqual(first, second) || isBefore(first, second);
    }
